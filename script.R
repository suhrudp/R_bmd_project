...
setwd("C:/Users/SURHUD/Desktop/Desktop/Stats/For/For Krutika Kadam/BMD")
...
# import data
df <- read_excel("C:/Users/SURHUD/Desktop/Desktop/Stats/For/For Krutika Kadam/BMD/data.xlsx")
attach(df)
df %>% colnames
